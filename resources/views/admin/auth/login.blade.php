...
<div class="login-box">
    ...
    <div class="login-logo ">
        <div class="row">
            <img src="{{asset('public/assets/dist/img/nagez-final-22.png')}}" alt="najezsoft">
        </div>
        <span class="brand-text-login font-weight-bold">POS</span>
    </div>
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            @include('admin.layouts.alerts.login')
            <form action="{{route('admin.login.post')}}" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="اسم المستخدم" name="email" >
                </div>
                <div class="input-group mb-3">
