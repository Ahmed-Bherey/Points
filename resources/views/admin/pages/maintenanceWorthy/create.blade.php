                ...
                <div class="row mt-1">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ route('maintenanceWorthy.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    {{-- row 1 --}}
                                    <div class="row mb-3">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">العملاء مستحقى الصيانة
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td class="d-flex justify-content-center">
                                                                <button type="submit" class="btn bg-secondary">
                                                                    <a href="{{ route('maintenanceWorthy.edit', $maintenance->id) }}"
                                                                        class="text-white"><i class="far btn fa-edit "
                                                                            aria-hidden="true"></i></a>
                                                                </button>
                                                                <form method="post"
                                                                    action="{{ route('maintenanceWorthy.destroy', $maintenance->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
