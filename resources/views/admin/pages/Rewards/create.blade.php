                ...
                <div class="row mt-1">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="{{ route('rewards.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    {{-- row 2 --}}
                                    <div class="row mb-3">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">مكافئات الموظفين
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                                    ...
                                                    @foreach ($rewards as $key => $reward)
                                                        <tr class="odd">
                                                            ...
                                                            <td class="d-flex justify-content-center">
                                                                ...
                                                                <form method="post"
                                                                    action="{{ route('rewards.destroy', $reward->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
