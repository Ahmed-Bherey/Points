                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card card-info">
                            <div class="card-header header-bg">
                                <h3 class="card-title" style="float: right"> القروض أول المدة </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-4 form-floating">
                                            <input type="text" class="form-control" id="name" placeholder="اسم صاحب"
                                                name="name">
                                            <label for="name" class="col-form-label">اسم صاحب
                                                القرض</label>
                                        </div>
                                        <div class="col-sm-4 form-floating">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="float:right; font-weight:bold;"> القروض
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
