                ...
                <div class="row mt-1">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card card-info">
                            ...
                            <form action="{{ route('covenantData.store') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    {{-- row 1 --}}
                                    <div class="row mb-3">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="float:right; font-weight:bold;"> أصحاب العهد
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                                ...
                                                <tbody>
                                                    @foreach ($covenants as $key => $covenant)
                                                        <tr class="odd">
                                                            ...
                                                            <td>{{ $covenant->notes }}</td>
                                                            <td class="d-flex justify-content-center">
                                                                <button type="submit" class="btn bg-secondary ">
                                                                    <a href="{{ route('covenantData.edit', $covenant->id) }}"
                                                                        class="text-white"><i class="far fa-edit "
                                                                            aria-hidden="true"></i></a>
                                                                </button>
                                                                <form method="post"
                                                                    action="{{ route('covenantData.destroy', $covenant->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
