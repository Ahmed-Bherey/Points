...
class CreateReturnedPurchaseTotalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('returned_purchase_totals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('returned_purchase_totals');
    }
}
